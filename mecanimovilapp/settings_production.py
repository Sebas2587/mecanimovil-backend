...
AGENTE_IA_THINK_DELAY_SECONDS = int(os.environ.get('AGENTE_IA_THINK_DELAY_SECONDS', '0'))
AGENTE_IA_MULTIMODAL_MODEL = os.environ.get('AGENTE_IA_MULTIMODAL_MODEL', 'gemini-2.5-flash')
AGENTE_IA_MULTIMODAL_TIMEOUT = int(os.environ.get('AGENTE_IA_MULTIMODAL_TIMEOUT', '45'))
...
ASISTENTE_COTIZACION_IA_ENABLED = os.environ.get(
    'ASISTENTE_COTIZACION_IA_ENABLED', 'False'
).lower() in ('true', '1', 'yes')
ASISTENTE_COTIZACION_IA_TIMEOUT = int(os.environ.get('ASISTENTE_COTIZACION_IA_TIMEOUT', '45'))
ASISTENTE_COTIZACION_GEMINI_MODEL = os.environ.get('ASISTENTE_COTIZACION_GEMINI_MODEL', '')
ASISTENTE_COTIZACION_GEMINI_FALLBACKS = os.environ.get(
...
# cualquier acceso anónimo (API o HTML) devuelve 403 / muro de login, sin importar
# la IP de origen. El refresh_token real se guarda en DB vía /ml/oauth/authorize/
# (ver valoracion_mercado/oauth_views.py); estas env solo alimentan el intercambio.
