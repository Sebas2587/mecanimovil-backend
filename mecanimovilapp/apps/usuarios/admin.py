...
class TallerAdmin(GISModelAdmin):
    ...
    fieldsets = (
        ...
        ('Datos del Onboarding', {
            'fields': ('descripcion', 'politicas_cotizacion', 'dias_validez_cotizacion', 'rut'),
        }),
...
class MecanicoDomicilioAdmin(GISModelAdmin):
    ...
    fieldsets = (
        ...
        ('Datos del Onboarding', {
            'fields': ('descripcion', 'politicas_cotizacion', 'dias_validez_cotizacion', 'dni', 'experiencia_anos'),
        }),
        ('Especialidades y Marcas', {
            'fields': ('especialidades', 'marcas_atendidas'),
